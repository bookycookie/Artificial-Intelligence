...
if __name__ == '__main__':
    ...
    NN.addLayer(LinearLayer(input_size, num))
    #NN.addLayer(LinearLayer(num, num2))
    NN.addLayer(SigmoidLayer())
    #NN.addLayer(LinearLayer(num2, num))
    NN.addLayer(LinearLayer(num, output_size))
    ...
    numIterations = 15000  # Number of iterations to run the genetic algorithm for
    ...
    print_every = 10 # Print the output every this many iterations
